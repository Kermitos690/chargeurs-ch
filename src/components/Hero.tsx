...
const Hero = () => {
  ...
  return <section className="relative min-h-screen pt-32 pb-20 overflow-hidden flex items-center">
            ...
            <div className="relative">
              <div className="glass-panel rounded-3xl overflow-hidden p-1 shadow-elevation">
                <div className="aspect-[4/3] rounded-2xl overflow-hidden">
                  <img src="https://images.unsplash.com/photo-1649972904349-6e44c42644a7?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=900&ixid=MnwxfDB8MXxyYW5kb218MHx8fHx8fHx8MTY0MDM1OTcyOA&ixlib=rb-1.2.1&q=80&w=1600" alt="Recharge de véhicule électrique" className="w-full h-full object-cover" loading="eager" />
                </div>
              </div>
